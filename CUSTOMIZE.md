> English | [中文](CUSTOMIZE.zh.md)

# DevOS Customization Prompt

## How to use

Paste everything below the line into Claude Code. It works two ways:

**Quick start (recommended):** Just paste the prompt. Claude will ask you
questions one group at a time. Most answers take 5 seconds. When it asks
about development principles, take 60 seconds to think — that answer
shapes every interaction going forward.

**Pre-prepared:** If you've already written down your project details,
paste them after the prompt. Claude will extract what it can and only
